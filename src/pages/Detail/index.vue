          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="supSaleAttr in spuSaleAttrList" :key="supSaleAttr.id">
                <dt class="title">选择{{ supSaleAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  v-for="spuSaleAttrValue in supSaleAttr.spuSaleAttrValueList"
...
export default {
  ...
  mounted() {
    this.$store.dispatch("detail/getGoodsDetail", this.$route.params.goodsId);
  },
  computed: {
    ...mapGetters("detail", ["categoryView", "skuInfo", "spuSaleAttrList"]),
  },
  methods: {
    chooseAttrValue(spuSaleAttrValue, spuSaleAttrValueList) {
